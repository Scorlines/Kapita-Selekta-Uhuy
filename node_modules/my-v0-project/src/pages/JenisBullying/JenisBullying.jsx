...
function JenisBullying() {
  ...
  const { updateReportData } = useReport(); // ← TAMBAH INI
  ...
  const handleTypeClick = (type) => {
    ...
    // Simpan jenis bullying ke Context (untuk kirim ke database nanti)
    updateReportData('type', type); // ← TAMBAH INI
    
    // Simpan juga ke sessionStorage (untuk keperluan lain jika perlu)
