...
function Response4() {
  ...
  const bullyingType = sessionStorage.getItem('bullyingType') || 'Aku gak diajak main / belajar bareng';
      ...
      <div className="response-content">
        ...
        <div className="bear-section">
          <div className="speech-bubble">
            <p>Wah, Nobi akan bantu jaga ceritamu biar aman, ya. Yuk ceritakan lebih detail supaya bisa ditangani dengan baik.</p>
          </div>
